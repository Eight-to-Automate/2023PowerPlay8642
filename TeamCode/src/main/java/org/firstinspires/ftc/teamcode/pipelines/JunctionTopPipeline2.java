...
public class JunctionTopPipeline2 extends OpenCvPipeline
{
    ...
    public JunctionTopPipeline2(boolean enableDashboard, double hmin, double hmax, double smin, double smax, double vmin, double vmax) {
